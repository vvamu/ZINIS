...
//                ResultNode.Symbol = '*';
//                Console.WriteLine($"[{oldLow} ; {oldHigh}]");

//                foreach (var letter in source)
//                {
//                    var high = oldLow + (oldHigh - oldLow) * Nodes.Find(x => x.Symbol == letter).High;
//                    var low = oldLow + (oldHigh - oldLow) * Nodes.Find(x => x.Symbol == letter).Low;

//                    Console.WriteLine(letter + ":" + $"\t {low} \t..  {high} ");
...
//                Console.WriteLine();
//                Console.WriteLine(item + " ; ResultNode.High  " + ResultNode.High + " ; ResultNode.Low " + ResultNode.Low);
